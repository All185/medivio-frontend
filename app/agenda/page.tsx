  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--background)' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-3"><img src="/icons/calendar_full.jpg" className="w-12 h-12 object-contain" style={{mixBlendMode:"multiply"}}/> {t('agenda.title')}</h2>
